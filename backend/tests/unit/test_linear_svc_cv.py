...
from ml.evaluation.linear_svc_cv import evaluate_linear_svc_cv
...
def test_grouped_cv_creates_a_fresh_pipeline_for_each_fold():
    ...
    evaluate_linear_svc_cv(development_frame(), pipeline_factory=pipeline_factory)
