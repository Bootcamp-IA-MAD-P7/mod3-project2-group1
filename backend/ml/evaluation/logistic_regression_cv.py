"""Grouped development-set evaluation for the Logistic Regression baseline."""
...
def evaluate_logistic_regression_cv(
    ...
    pipeline_factory: PipelineFactory = create_logistic_pipeline,
) -> dict[str, Any]:
    """Evaluate fresh Logistic Regression pipelines with grouped CV on DEV only."""
