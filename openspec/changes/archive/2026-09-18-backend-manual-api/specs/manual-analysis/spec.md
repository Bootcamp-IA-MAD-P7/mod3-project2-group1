...
Al aplicar el change, ejecutar tests de contrato (RED antes de GREEN), integración ASGI con TestClient, lint y validaciones OpenSpec estrictas cuando la CLI esté disponible. Los tests de este slice no requieren base de datos, YouTube ni MLflow.